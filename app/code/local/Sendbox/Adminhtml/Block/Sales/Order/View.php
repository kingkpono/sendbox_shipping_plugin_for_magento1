 ...
 */
class Sendbox_Adminhtml_Block_Sales_Order_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $coreHelper = Mage::helper('core');
         ...
         $this->_addButton('sendbox_shipment', array(
                'label'     => Mage::helper('sales')->__('Ship via Sendbox'),
                  'onclick'   => 'setLocation(\''.Mage::helper('adminhtml')->getUrl('/shipments_shipment/getquote',array('order_id' =>$this->getOrderId())). '\')',
            ));
         }
    ...
    public function getSenboxUrl()
    {
       
          return  Mage::helper('adminhtml')->getUrl('/shipments_shipment/post',array('order_id' =>$this->getOrderId()));
