 ...
 */
/**
 * Shipment comment form block
 *
 * @category    Sendbox
 * @package     Sendbox_Shipments
 * @author Ultimate Module Creator
 */
class Sendbox_Shipments_Block_Shipment_Comment_Form extends Mage_Core_Block_Template
{
    /**
     * initialize
     *
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $data =  Mage::getSingleton('customer/session')->getShipmentCommentFormData(true);
    ...
    {
        return Mage::getUrl(
            'sendbox_shipments/shipment/commentpost',
            array('id' => $this->getShipment()->getId())
        );
    }
}
