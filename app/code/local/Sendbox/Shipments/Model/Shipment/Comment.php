 ...
 */
/**
 * Shipment comment model
 *
 * @category    Sendbox
 * @package     Sendbox_Shipments
 * @author      Ultimate Module Creator
 */
class Sendbox_Shipments_Model_Shipment_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'sendbox_shipments_shipment_comment';
    const CACHE_TAG = 'sendbox_shipments_shipment_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'sendbox_shipments_shipment_comment';
