 ...
 */
class Sendbox_Shipments_Model_Adminhtml_Source_Yesnodefault extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    const YES = 1;
    const NO = 0;
    const USE_DEFAULT = 2;
    ...
    public function toOptionArray()
    {
        return array(
            array(
                'label' => Mage::helper('sendbox_shipments')->__('Use default config'),
