 ...
 */
/**
 * Shipment comments resource collection model
 *
 * @category    Sendbox
 * @package     Sendbox_Shipments
 * @author      Ultimate Module Creator
 */
class Sendbox_Shipments_Model_Resource_Shipment_Comment_Shipment_Collection extends Sendbox_Shipments_Model_Resource_Shipment_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('sendbox_shipments/shipment_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.shipment_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('sendbox_shipments/shipment_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.shipment_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
